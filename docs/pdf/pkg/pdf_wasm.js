 ...
 * @returns {number}
 */
export function get_page_count(pdf_bytes) {
 ...
 * @param {any} pdf_arrays
 * @param {number} quality
 * @returns {Uint8Array}
 */
export function merge_and_compress(pdf_arrays, quality) {
    const ret = wasm.merge_and_compress(pdf_arrays, quality);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
