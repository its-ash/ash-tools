 ...
 */
export function unzip_files(zip_bytes: Uint8Array): Array<any>;

/**
 * Build a ZIP archive in-memory using the provided file names and byte buffers.
 */
export function zip_files(names: Array<any>, contents: Array<any>): Uint8Array;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
    readonly memory: WebAssembly.Memory;
    readonly unzip_files: (a: any) => [number, number, number];
    readonly zip_files: (a: any, b: any) => [number, number, number];
